...
const ItemSurah = ({ nomor, namaSurah, artiSurah, tempatTurunSurah, jumlahAyat }) => {
    return (
        <div className="h-24 w-full border-b-2  border-sky-800 flex mb-4">
            <div className="basis-12 flex justify-end mr-4">
                <h3 className="text-2xl font-bold  text-sky-800">{nomor}</h3>
            </div>
            <div className="flex flex-col">
                <h3 className="text-2xl font-bold text-sky-800">{namaSurah}</h3>
